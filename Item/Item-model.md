...
From column: _GeneralFormat_
``` python
return UM.uri_from_fields("object/type/",getValue("AAT_Type"))
```
...
if len(getValue('AAAT_FormatURI')):
    return getValue('AAAT_FormatURI')
else:
...
| _AAT_TypeURI_ | `uri` | `crm:E55_Type1`|
...
| _DataDateStamp_ | `rdfs:label` | `crm:E52_Time-Span2`|
...
| _ExtentType_ | `rdf:value` | `crm:E33_Linguistic_Object6`|
| _ExtentTypeURI_ | `uri` | `crm:E33_Linguistic_Object6`|
...
| `crm:E12_Production2` | `crm:P4_has_time-span` | `crm:E52_Time-Span2`|
...
| `crm:E22_Man-Made_Object1` | `crm:P67i_is_referred_to_by` | `crm:E33_Linguistic_Object6`|
...
| `crm:E42_Identifier1` | `crm:P108i_was_produced_by` | `crm:E12_Production2`|
