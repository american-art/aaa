<!-- stephboxreel generated by Steph 6/05 using Loren's stylesheet generated by Loren 1/31/02 from EAD Cookbook Style 2 and Michael Fox's changes to the container list Version 0.9   2000 July 22; incorporating changes attempting to accomodate EAD Cookbook v. 2  -->
<!--  This stylesheet generates Style 2 and Michael Fox's addition for boxes and reels which has a Table of Contents in an HTML table cell along the left side of the screen. It may be used when an HTML frame is not desired.  -->
...
<!--The first option selects cases where either the value of the box container or the reel
...
<xsl:when test="not($boxnumber = $prevboxnumber
      and
      $reelnumber = $prevreelnumber) or (not(../preceding-sibling::c02[1]) and ((../../@level) or (../../@otherlevel)))" >
...
<xsl:choose>
  ...
  <xsl:otherwise>
    ...
    <xsl:when test="not($boxnumber = $prevboxnumber
      and
      $reelnumber = $prevreelnumber) or (not(../preceding-sibling::c03[1]) and ((../../@level) or (../../@otherlevel)))" >
...
<xsl:choose>
  ...
  <xsl:otherwise>
    ...
    <xsl:choose>
      <xsl:when test="not($boxnumber = $prevboxnumber
      and
      $reelnumber = $prevreelnumber) or (not(../preceding-sibling::c04[1]) and ((../../@level) or (../../@otherlevel)))" >
...
<xsl:choose>
  ...
  <xsl:otherwise>
    ...
    <xsl:choose>
      <xsl:when test="not($boxnumber = $prevboxnumber
      and
      $reelnumber = $prevreelnumber) or (not(../preceding-sibling::c05[1])  and ((../../@level) or (../../@otherlevel)))">
